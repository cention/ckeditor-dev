...
( function() {
	...
	CKEDITOR.plugins.add( 'cention_avatar', {
		...
		init: function( editor ) {
			...
			var config = editor.config,
				lang = editor.lang.cention_avatar,
			...
			// got to be refined.
			config.filebrowserCention_avatarBrowseUrl = config.filebrowserImageBrowseUrl;
			config.filebrowserCention_avatarUploadUrl = config.filebrowserImageUploadUrl;
			...
			editor.ui.addButton && editor.ui.addButton( 'Cention_avatar', {
				label: 'Insert Avatar',
				command: 'image',
				toolbar: 'insert'
			} );
			...
			CKEDITOR.dialog.add( 'cention_avatar', this.path + 'dialogs/cention_avatar.js' );
		},
	...
	function widgetDef( editor ) {
		var alignClasses = editor.config.cention_avatar_alignClasses,
			captionedClass = editor.config.cention_avatar_captionedClass;
		...
		return {
			...
			init: function() {
				var helpers = CKEDITOR.plugins.cention_avatar,
	...
	CKEDITOR.plugins.cention_avatar = {
		stateShifter: function( editor ) {
			// Tag name used for centering non-captioned widgets.
			var doc = editor.document,
				alignClasses = editor.config.cention_avatar_alignClasses,
				captionedClass = editor.config.cention_avatar_captionedClass,
				...
				hasCaption:	function( shift, oldValue, newValue ) {
					...
					if ( newValue ) {
						...
						var figure = CKEDITOR.dom.element.createFromHtml( templateBlock.output( {
							...
							captionPlaceholder: editor.lang.cention_avatar.captionPlaceholder
						} ), doc );
	...
	function centerWrapperChecker( editor ) {
		var captionedClass = editor.config.cention_avatar_captionedClass,
			alignClasses = editor.config.cention_avatar_alignClasses,
	...
	function setupResizer( widget ) {
		...
		resizer.setAttribute( 'title', editor.lang.cention_avatar.resizer );
	...
	function getWidgetAllowedContent( editor ) {
		var alignClasses = editor.config.cention_avatar_alignClasses,
			rules = {
				...
				figure: {
					classes: '!' + editor.config.cention_avatar_captionedClass
				},
				figcaption: true
			};
 ...
 */
CKEDITOR.config.cention_avatar_captionedClass = 'image';
